...
File: calendar.js
Description:  this file will contains code for build and handle calender application.
=========================================================================
=========================================================================
*/
(function () {
  ...
  var calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
    ...
    select: function (info) {
      ...
      document.getElementsByTagName('body')[0].appendChild(backDropOverlay);
      document.getElementById('offcanvasoverlay').addEventListener('click', function (event) {
        offcanvasclose();
      });
      calendar.unselect();
    },
    eventClick: function (info) {
      ...
      setTimeout(function () {
        calendarmodal.classList.add('animate');
      }, 100);
      var backDropOverlay = document.createElement('div');
